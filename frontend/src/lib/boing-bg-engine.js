...
const BOING_BG_CONFIGS = {
  ...
  finance: {
    ...
    /** Non-home routes: one calm preset (brand navy + cyan/purple nebula, light grid + particles). */
    feature: {
      baseBg: ['#010615', '#020b26', '#06122e'],
      accentColor: '#00e5ff',
      accentColor2: '#5b21b6',
      ...
      starOpacityMax: 0.48,
      nebulaClouds: [
        { x: 0.12, y: 0.10, r: 220, color: '#5b21b6', opacity: 0.038 },
        { x: 0.82, y: 0.09, r: 200, color: '#00e5ff', opacity: 0.028 },
        { x: 0.48, y: 0.18, r: 150, color: '#00ff88', opacity: 0.020 },
      ],
      shootingStarColor: '#00e5ff',
      shootingStarColor2: '#7c3aed',
